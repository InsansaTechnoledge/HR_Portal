            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Investment Tracker</h1>
                            <p className="text-slate-500 mt-1">Manage and review employee tax declarations</p>
                        </div>
                    </div>
                    <Button
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: 'Drafts', value: stats.draft, color: 'text-slate-600', icon: AlertCircle, bg: 'bg-slate-100' },
                    ].map((stat, i) => (
                                            ...
                                            <tr key={dec._id} className="border-b border-slate-100 hover:bg-slate-50/50 transition-colors group">
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    <div className="flex items-center justify-center gap-1.5">
                                                        ...
                                                        {[
                                                            ...
                                                            <Dialog key={idx}>
                                                                <DialogTrigger asChild>
                                                                    <Button variant="ghost" size="sm" className="h-7 px-2 text-[10px] font-bold border hover:bg-slate-100">
                                                                    ...
                                                                    <div className="space-y-2 mt-4">
                                                                        {item.docs.map((doc, docIdx) => (
                                                                            <div key={docIdx} className="flex items-center justify-between p-3 rounded-lg border bg-slate-50/50 hover:bg-slate-50 transition-colors">
                                                                                ...
                                                                                <Button size="icon" variant="ghost" className="h-8 w-8 text-primary" onClick={() => window.open(doc.driveUrl, '_blank')}>
                                                        ...
                                                        {(!dec.hraDocuments?.length && !dec.ltaDocuments?.length && !dec.section80CDocuments?.length) && (
                                                            <span className="text-slate-400 text-xs italic">No docs</span>
                                                        )}
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 text-center">
